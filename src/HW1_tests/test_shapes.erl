...
test() ->
  ...
  try shapes:shapesArea({shapes, [Square1, Square1, Rectangle_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 29")
  catch
    error:Error0 -> erlang:display({error, caught, Error0})
  end,

  try shapes:shapesArea({shapes, [Square1, Square1, Rectangle_ill2]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 35")
  catch
  ...
  try shapes:shapesArea({shapes, [Circle2, Triangle_ill, Square1]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 44")
  catch
    error:Error2 -> erlang:display({error, caught, Error2})
  end,

  try shapes:squaresArea({shapes, [Circle2, Triangle_ill, Square1]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 50")
  catch
  ...
  try shapes:trianglesArea({shapes, [Circle2, Triangle_ill, Square1]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 60")
  catch
  ...
  try F1({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 78")
  catch
  ...
  try F2({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 91")
  catch
  ...
  try F3({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 103")
  catch
  ...
  try F4({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 121")
  catch
  ...
  try F5({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 133")
  catch
  ...
  try F6({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 145")
  catch
  ...
  try F7({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 158")
  catch
  ...
  try F8({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code line 170")
  catch
